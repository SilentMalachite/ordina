...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">新規取引作成</h1>
        ...
        <form method="POST" action="{{ route('transactions.store') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            ...
            <div class="mb-4">
                ...
                <select name="type" id="type" 
                    ...
                    <option value="sale" {{ old('type') == 'sale' ? 'selected' : '' }}>売上</option>
                    <option value="rental" {{ old('type') == 'rental' ? 'selected' : '' }}>貸出</option>
                </select>
                @error('type')
            ...
            <div class="mb-4">
                ...
                @error('product_id')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
                <p class="text-sm text-gray-600 mt-1">在庫数: <span id="stock-display">-</span></p>
            </div>
            ...
            <div class="mb-4">
                ...
                @error('unit_price')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
                <p class="text-sm text-gray-600 mt-1">合計金額: ¥<span id="total-amount">0</span></p>
            </div>
            ...
            <div class="mb-4" id="expected-return-date-field" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateProductInfo() {
        ...
        if (selectedOption && selectedOption.value) {
            ...
            // Use selling price for sales, unit price for rentals
            if (typeSelect.value === 'sale' && sellingPrice) {
