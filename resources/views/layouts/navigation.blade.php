        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('job-statuses.index')" :active="request()->routeIs('job-statuses.*')">
                        ジョブ状況
                    </x-nav-link>
                    @can('system-manage')
                        <x-nav-link :href="route('admin.index')" :active="request()->routeIs('admin.*') || request()->routeIs('roles.*')">
                            管理者
                        </x-nav-link>
                    @endcan
                    @can('log-view')
